...
export default async function Home({ searchParams }: { searchParams: Promise<{ location?: string }> }) {
  ...
  return <main className="min-h-screen bg-[#f7f4ee] pb-24 md:pb-0">
    <section className="relative min-h-[540px] overflow-hidden bg-[#123f3e] text-white md:min-h-[620px]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[540px] max-w-7xl items-end px-5 pb-16 pt-28 md:min-h-[620px] md:px-8"><div className="max-w-xl">
        ...
        <p className="mb-4 flex items-center gap-2 text-xs font-bold uppercase tracking-[.22em] text-[#ffd3b8]"><Sun size={16}/><T k="hello"/></p>
        <h1 className="font-display text-4xl leading-[.98] tracking-[-.03em] sm:text-6xl md:text-7xl">Marhaba Salem<br/>Resort</h1>
        <p className="mt-5 max-w-md text-lg leading-relaxed text-white/85"><T k="enjoy"/></p><div className="mt-6 max-w-lg"><GlobalSearch/></div>
      </div></div>
    </section>
